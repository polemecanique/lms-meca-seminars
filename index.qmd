...
### Alexander Erlich (LiPhy, Universite Grenoble Alpes)

**Date and Place:** September 24, 2026 at the Pole Mecanique amphitheatre <br>
**Title:** The geometric nature of residual stress in growing tissues

::: {.button}

[<iconify-icon icon="fa-solid:chalkboard" aria-label="announcement"></iconify-icon> Abstract & Bio](Resources/lms-seminar-docs/docs/26-09-12-abstract-announcements/26-0924-AlexErlich/01-lms-seminar-external.pdf){.button target="_blank"}
...
[![](Resources/lms-seminar-docs/docs/26-09-12-abstract-announcements/26-0924-AlexErlich/02-lms-seminar-external.png){fig-align="left" width="60%"}](Resources/lms-seminar-docs/docs/26-09-12-abstract-announcements/26-0924-AlexErlich/02-lms-seminar-external.png)
