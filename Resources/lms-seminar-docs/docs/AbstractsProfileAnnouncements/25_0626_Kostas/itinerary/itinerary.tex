...
\begin{document}
	...
	\vspace*{-2em}
	\begin{center}
		\huge \textbf{Kostas Karapiperis visit itinerary}
	\end{center}
	\begin{center}
		\Large
		Thursday June 25\\
		\begin{tabular}{| p{4cm} p{13cm} |}
			...
			0900 -- 0945 & Coffee \& Lab tour\\
			0945 -- 1030 & Alexandre Daby-Seesaram \\
			1030 -- 1110 & Manas Upadhyay\\
			1110 -- 1150 & Laurent Guin \\
			1150 -- 1330 & Lunch w/ Vignesh, Kostas Danas, Alexandre \& Laurent \newline (restaurant:~19 Palaiseau) \\
			1345 & Prep. for seminar \\
			1400 -- 1500 & Seminar (Amphi 104) \\ 
			1515 -- 1600 & Kostas Danas \\
			1600 -- 1630 & Vignesh \\
			1630 & Leave campus for Gare de Lyon \\
			\hline
		\end{tabular}
		\vspace*{1em}
	\end{center}
