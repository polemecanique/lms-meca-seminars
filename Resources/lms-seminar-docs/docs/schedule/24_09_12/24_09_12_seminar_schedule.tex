...
\begin{document}
	...
	\begin{center}
		...
		\begin{tabular}{| p{4.5cm} p{12cm} |}
			\hline
			September 19 & Adrien Baldit (Universit{\'e} de Lorraine) \\
			September 26 & Arthur Despres (Grenoble INP, Universit{\'e} Grenoble Alpes) \\
			October 03 & Hao Gao (University of Glasgow) \\
			October 10 & Jean-Charles Passieux (INSA de Toulouse) \\
			October 17 & Beno{\^i}t Roman (PMMH -- ESPCI, Paris) \\
			November 07 & Angkur Jyoti Dipanka Shaikeea (University of Cambridge) \\
			November 14 &  \\
			\rowcolor{docColor!99}
			\textcolor{white}{November 21} & \textcolor{white}{MECA seminar: Martina Bramberger (NorthWest Research Associates, Boulder)} \\
			November 28 &  MEDISIM seminars and workshop (all day) \\
			December 05 & Pedro Reis-John Hutchinson joint seminar (EPFL-Harvard) \\
			\rowcolor{docColor!99}
			\textcolor{white}{December 11} & \textcolor{white}{MECA Seminar: Triona Lally (Trinity College Dublin)}\\
			December 19 &  Marie-Agathe Charpagne (U. Illinois Urbana-Champaign)\\
			\hline
		\end{tabular}
	\end{center}
