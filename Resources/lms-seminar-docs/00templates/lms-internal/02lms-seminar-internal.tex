...
\begin{tikzpicture}[remember picture, overlay]
	...
	\node[anchor=center] (summary) at (current page.center) [xshift=1em, yshift=-8em] {
		\begin{minipage}{0.90\linewidth}
			\centering
			\vspace*{0em}
			{\Large \textbf{Moderator:}~Vignesh Kannan \\
			\vspace{1em}
			\textbf{Speakers:}~Alistair Rowe (LPMC - Laboratoire de Physique de la Matière Condensée), Andrea Rocchi (Drahi'X Innovation center), Laurence Bodelot \& Vignesh Kannan (LMS) \\}
			\vspace*{1em}
			{\Large \textbf{Date and Time}:~September 17, 2026 (2 -- 3 pm) \\ 
				\vspace*{0.5em}
