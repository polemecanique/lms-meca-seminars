...
\newcommand{\insertETHheader} {
\pagestyle{fancy}
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\footrulewidth}{1pt}
\fancyfoot[R]{\sffamily Cover letter --- Vignesh Kannan, p.\thepage}
\fancyhead[L]{\includegraphics[width=0.4\textwidth, keepaspectratio]{format/ETHlogo_13}}
\fancyhead[R]{}
}

\newcommand{\insertLXheader} {
	\pagestyle{fancy}
	\renewcommand{\headrulewidth}{0pt}
	\renewcommand{\footrulewidth}{0pt}
	\fancyfoot[C]{\sffamily \Large \href{https://calendar.google.com/calendar/u/0/embed?src=lms.seminaires@gmail.com&ctz=Europe/Zurich}{Google calendar link} \hspace*{0.5em} \textbullet \hspace*{0.5em} \href{https://polemecanique.github.io/lms-meca-seminars/}{Seminar webpage link}} 
	\fancyhead[L]{\includegraphics[width=0.4\textwidth, keepaspectratio]{format/lxipparis2.png}}
	\fancyhead[R]{\includegraphics[width=0.15\textwidth, keepaspectratio]{format/lms.png}}
}
