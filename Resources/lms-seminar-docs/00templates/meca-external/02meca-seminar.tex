...
\usepackage[
	paperheight=13cm, paperwidth=21cm,
	left=1.50cm, right=1.50cm, top=3cm, bottom=2cm, 
	headheight= 3cm, headsep= 4pt, footskip=25pt
	]{geometry}
...
\begin{tikzpicture}[remember picture, overlay]
	\begin{scope}
		...
		\node[anchor=west] (image) at (current page.west) [xshift=4em, yshift=-7em] {
	...
	\node[anchor=west] (summary) at (image.east) [xshift=1em, yshift=0em] {
		\begin{minipage}{0.60\linewidth}
			\raggedright \large
			\vspace*{0em}
			{\Large \textbf{Thao (Vicky) Nguyen} \\ 
			Department of Mechanical Engineering \\
			Johns Hopkins University} \\
			\vspace*{1em}
			{\Large \textbf{Date and Time}:~January 08, 2026 (2 -- 3 pm) \\ 
				\vspace*{0.25em}
